...
public static function ShowReSultProject($idDuAN) 
{
    ...
    // LOẠI DỰ ÁN 3 5 6
    $sql = "SELECT kqng.ID_KetQuaNhanGhi, kqng.ID_NguoiDung,nd.Ten, da.TenDuAn, lda.TenLoai, tv.TacVu , kqng.ketqua 
...
$sql2="SELECT kqn.ID_KetQuaNhan,tv.ID_TacVu ,n.Nhan,kqn.ID_NguoiDung, nd.Ten ,tv.TacVu,kqn.TuNgu,da.tenDuAn,lda.TenLoai 
